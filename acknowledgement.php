...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <br>
        <div class="hidden columns col-lg-12 blog-main">
        ...
        <div class="columns col-lg-12 blog-main">
          <div class="table-responsive">
            <?php $schedule = $model->getAllSchedule(); 
            ?>
            <table class="table table-hovered table-striped" id="result">
              ...
              <tbody>
                <?php foreach($schedule as $idx => $u): ?>
                <tr class="preview" data-id="<?= $u['basic']['id'];?>">
                  <td><?= $u['basic']['consumer'];?></td>
                  <td><?= $u['basic']['address'];?></td>
                  <td><?= $u['basic']['nature'];?></td>
                  <td><?= $u['basic']['start'];?></td>
                </tr>
                <?php endforeach ?>
              </tbody>
      ...
      var Page = {
        ...
        preview   : function(){
          ...
          getPreview.on("click", function(e){
            var me      = $(this);
            var href    = "acknowledgement_export.php?id=" + me.data("id");
