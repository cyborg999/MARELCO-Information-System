  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="blog-header">
        <h1 class="blog-title">Lineman/Inspector List</h1>
      ...
      <div class="row">
        <div class="col-sm-12 blog-main">
          ...
          <?php $users = new Model(); $userList = $users->getAllUsers(true,"inspector");?>
              ...
              <tbody>
                  <?php foreach($userList as $idx => $user): ?>
                      <tr style="opacity:<?= ($user['deleted'] == 1) ? ".3" : "1"; ?>;">
                          ...
                          <td>
                            <a class="btn btn-primary btn-sm" href="scheduler.php?id=<?= $user['mainId'];?>">view</a>
                          </td>
                      </tr>
                  <?php endforeach ?>
              </tbody>
