  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="blog-header">
        <h1 class="blog-title">Add <span id="userType">Lineman/Inspector</span>'s information</h1>
...
<div class="row">
        ...
        <input type="hidden" name="walkInApplicant" id="user-role" value="true"/>

        <input type="hidden" name="photo" id="photo" class="form-control" placeholder="photo..."/>
        <div class="col-sm-12 q">
          <table class="table">
            <thead>
              <tr>
            ...
            <tr class="system-user hidden">
                <td><label class="control-label">Username</label></td>
                <td>
                  <input type="text" id="username" name="username" class="form-control m-b-10" placeholder="Username">
                </td>
            </tr>
             <tr class="system-user hidden">
                <td><label class="control-label">Email</label></td>
                <td>
                  <input type="email" name="email" class="form-control m-b-10" placeholder="Email Address">    
                </td>
            </tr>
             <tr class="system-user hidden">
                <td><label class="control-label">Password</label></td>
                <td>
                  <input type="password" name="password" class="form-control m-b-10" placeholder="Password">
                </td>
            </tr>
             <tr class="system-user hidden">
                <td><label class="control-label">Retype Password</label></td>
                <td>
                  <input type="password" name="password2" class="form-control m-b-20" placeholder="Confirm password">
                </td>
            </tr>
               <tr>
                <td><label class="control-label" for="contact_number">Contact Number</label></td>
                <td><input class="form-control" type="text" id="contact_number"  name="contact_number" placeholder="contact number..."></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>  <input class="form-control" type="text" id="lastname" required name="lastname" placeholder="lastname..."></td>
              </tr>
              <tr>
                <td><label class="control-label" for="middlename">Middlename</label></td>
                <td><input class="form-control" type="text" id="middlename" required name="middlename" placeholder="middlename..."></td>
              </tr>
              ...
              <tr>
                ...
                <td><input class="form-control" type="text"  id="dob" name="dob" placeholder="Date of Birth..."></td>
              </tr>
              <tr>
                <td><label class="control-label" for="pob">Place of Birth</label></td>
                <td> <input class="form-control" type="text" id="pob" name="pob" placeholder="Place of Birth..."></td>
              </tr>
              <tr>
                <td><label class="control-label" for="age">Age</label></td>
                <td><input class="form-control" readonly type="text" id="age" name="age" placeholder="age..."></td>
              </tr>
              <tr>
              ...
              <tr class="hidden">
                ...
                <td><input class="form-control" type="text" id="weight" name="weight" placeholder="weight..."></td>
              </tr>
              <tr class="hidden">
                <td><label class="control-label" for="height">Height</label></td>
                <td><input class="form-control" type="text"  id="height" name="height" placeholder="height..."></td>
              </tr>
            </tbody>
          </table>
    ...
    (function($){
      var Page = {
        ...
        __listen : function(){
          ...
          //   $("#userType").html($(this).find("option:selected").text());

          //   var val = $(this).val();

          //   if( (val== "line_man") || val =="inspector"){
          //     $(".system-user").addClass("hidden");
          //     $("#user-role").attr("name", "walkInApplicant");
          //   } else {
          //     $(".system-user").removeClass("hidden");
          //     $("#user-role").attr("name", "notwalkin");
          //   }
          ...
          $("#branch").on("change", function(){
            var opt = $(this).find("option:selected").data("municipality");

            municipality.find("option[value='" + opt + "']").prop("selected","selected");
            ...
            $.ajax({
              ...
              success: function(response){
                ...
                if(response.added == true){
                    ...
                    window.location.href = "scheduler.php?id="+response.id;
