  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="blog-header">
        <h1 class="blog-title">Edit User's information</h1>
        <!-- <p class="lead blog-description">The official example template of creating a blog with Bootstrap.</p> -->
      </div>
<div class="row">
        <div class="col-sm-12 blog-main">
          <!-- other content goes here -->
          <?php $user = $model->getUserByUserId($_GET['id']); 
            $user = $user[0];
        ...
        <input type="hidden" name="userid" value="<?= $user['mainId']; ?>"/>
          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <select class="form-control" name="branchId" id="branch">
                    <?php foreach($branch as $b){ ?>
                      <option data-municipality="<?= $b['municipality'];?>" value="<?= $b['id'];?>" <?= ($user['branch_id'] == $b['id']) ? "selected" : "";?>><?= $b['name'];?></option>
                    <?php } ?>
                  </select>
                </td>
              </tr>
                ...
                <td>
                  <select class="select form-control" id="municipality" name="municipality">
                      <option value="boac" <?= ($user['municipality'] == "boac") ? "selected" : "";?>>Boac</option>
                      <option value="mogpog" <?= ($user['municipality'] == "mogpog") ? "selected" : "";?>>Mogpog</option>
                      <option value="gasan" <?= ($user['municipality'] == "gasan") ? "selected" : "";?>>Gasan</option>
                      <option value="stacrus" <?= ($user['municipality'] == "stacrus") ? "selected" : "";?>>Sta. Cruz</option>
                      <option value="buenavista" <?= ($user['municipality'] == "buenavista") ? "selected" : "";?>>Buenavista</option>
                      <option value="torrijos" <?= ($user['municipality'] == "torrijos") ? "selected" : "";?>>Torrijos</option>
                  </select>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  ...
                  <select class="form-control" name="brgy" id="brgy">
                    <?php foreach($brgy as $b){ ?>
                      <option value="<?= $b['name'];?>" <?= ($user['brgy'] == $b['name']) ? "selected" : "";?>><?= $b['name'];?></option>
                    <?php } ?>
                  </select>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td><input class="form-control" readonly type="text" id="age" name="age" value="<?= $user['age']; ?>"  placeholder="age..."></td>
              </tr>
              <tr>
                <td><label class="control-label" for="gender">Gender</label></td>
                <td>
                  <div class="radio-inline">
                    <label> <input type="radio" name="gender" id="male"  <?= ($user['sex'] == '')? 'checked': ''?><?= ($user['sex'] == 'male') ? 'checked' : ''; ?> value="male">Male</label>
                  </div>
                  <div class="radio-inline">
                    <label>
              ...
              <tr class="hidden">
                ...
                <td><input class="form-control" type="text" value="<?= $user['weight']; ?>"  id="weight" name="weight" placeholder="weight..."></td>
              </tr>
              <tr class="hidden">
                <td><label class="control-label" for="height">Height</label></td>
                <td><input class="form-control" type="text" value="<?= $user['height']; ?>"  id="height" name="height" placeholder="height..."></td>
              </tr>
            </tbody>
          </table>
