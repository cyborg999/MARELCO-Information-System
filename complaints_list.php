...
<html lang="en">
  ...
  <body>
    ...
    <script type="text/html" id="complaint">
        <tr>
            <td class="hiddesn"><a data-id="[ID]" data-nature="[COMPLAINT_NATURE]" href="updaterequirement.php?nature=[COMPLAINT_NATURE]&id=[ID]" class="btn btn-lg getChecklist"><span class="glyphicon glyphicon-edit"></span></a></td>
